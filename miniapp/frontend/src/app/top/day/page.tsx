...
export default function TopDay() {
  ...
  // При заходе в приложение посылаем запрос для получения топа игроков за день
  useEffect(() => {
  ...
  return (
    <div className="main">
      ...
      <div className="header-menu">
        ...
        <a className="data-items" href='./day' id='top-day'>День</a>
          <a className="data-items" href='./month'>Месяц</a>
          <a className="data-items" href='./balance'>Баланс</a>
        </div>
