...
export default function TopBalancePage() {
  ...
  useEffect(() => {
    const getPlayers = async () => {
      try {
        ...
        const data: IPlayerData[] = await response.json();
        setPlayers(data);
        setIsLoading(false);
      } catch (error) {
        console.error(error);
    ...
    <div className="main">
      ...
      <div className="header-menu">
        <div className="data-menu">
          ...
          <Link className="data-items" href="./balance" id='top-balance'>Баланс</Link>
        </div>
